...
function remainingBakeTime(timePassed) {
  timePassed = 0
  do {
    timePassed += 10
    console.log(timePassed)
  } while (timePassed < 50)
  const timeLeft = bakingTime() - timePassed
  return timeLeft
}
console.log(remainingBakeTime())
...
function calculatePreparationTime(layers) {
  layers = 3
  const timeTaken = layers * 3
  return timeTaken
}
console.log(calculatePreparationTime())
...
function totalTimeSpent(layers, timePassed){
}
